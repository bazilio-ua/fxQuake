...
void Mod_LoadClipnodes (lump_t *l)
{
	...
	for (i=0 ; i<count ; i++, out++, in++)
	{
		...
		if (out->planenum < 0 || out->planenum >= loadmodel->numplanes)
			Host_Error ("Mod_LoadClipnodes: planenum in clipnode %d out of bounds (%d, max = %d) in %s", i, out->planenum, loadmodel->numplanes, loadmodel->name);
...
{	
	...
	for ( i=0 ; i<count ; i++)
	{
		...
		if (j >= loadmodel->numsurfaces)
			Con_Warning ("Mod_ParseMarksurfaces: bad surface number (%d, max = %d) in %s\n", j, loadmodel->numsurfaces, loadmodel->name);
...
//
	mod->glowradius = 30;
	mod->glowcolours[0] = 0.7;
	mod->glowcolours[1] = 0.2;
	mod->glowcolours[2] = 0.05;

	if (!strcmp(mod->name, "progs/flame.mdl"))
	{
		mod->glowradius = 19.0;
		mod->glowtype = FX_TORCH;
	}
	...
	{
		mod->glowradius = 27.0;
		mod->glowcolours[0] = 0.05;
		mod->glowcolours[1] = 0.05;
		mod->glowcolours[2] = 0.2;
		mod->glowtype = FX_BOLT;
	}
	else if (!strcmp(mod->name, "progs/missile.mdl"))
	{
		mod->glowtype = FX_MISSILE;
	}
	else if (!strcmp(mod->name, "progs/laser.mdl"))
	{
		mod->glowradius = 10.0;
		mod->glowcolours[0] = 0.25;
		mod->glowcolours[1] = 0.025;
		mod->glowcolours[2] = 0.025;
		mod->glowtype = FX_ENTITY;
	}
	else if (!strcmp(mod->name, "progs/w_spike.mdl"))
	{
		mod->glowradius = 10.0;
		mod->glowcolours[0] = 0.025;
		mod->glowcolours[1] = 0.25;
		mod->glowcolours[2] = 0.025;
		mod->glowtype = FX_ENTITY;
	}
	else if (!strcmp(mod->name, "progs/v_spike.mdl"))
	{
		...
		mod->glowcolours[0] = 0.25;
		mod->glowcolours[1] = 0.025;
		mod->glowcolours[2] = 0.25;
		mod->glowtype = FX_ENTITY;
	}
	else if (!strcmp(mod->name, "progs/lavaball.mdl"))
	{
		mod->glowradius = 10.0;
		mod->glowcolours[0] = 0.75;
		mod->glowcolours[1] = 0.25;
		mod->glowcolours[2] = 0.05;
		mod->glowtype = FX_ENTITY;
	}
	...
	else if (!strcmp(mod->name, "progs/quaddama.mdl"))
	{
		...
		mod->glowcolours[1] = 0.05;
		mod->glowcolours[2] = 0.2;
		mod->glowtype = FX_POWERUP;
	}
	else if (!strcmp(mod->name, "progs/invulner.mdl"))
	{
		mod->glowradius = 20.0;
		mod->glowcolours[0] = 0.2;
		mod->glowcolours[1] = 0.05;
		mod->glowcolours[2] = 0.05;
		mod->glowtype = FX_POWERUP;
	}
