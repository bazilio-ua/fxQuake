...
#define	PROTOCOL_BJP2	10001	// Extended protocol (sounds > 256), problems with Marcher (compat. with BJP)
#define	PROTOCOL_BJP3	10002	// Extended protocol (sounds > 256), more compatible, but less functional (compat. with BJP)
...
// Nehahra
#define svc_fogn			51	// [byte] enable <optional past this point, only included if enable is true> [float] density [byte] red [byte] green [byte] blue
