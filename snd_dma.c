...
void S_Init (void)
{
	...
	Cvar_Register (&nosound);
	Cvar_Register (&volume);
	Cvar_Register (&precache);
	Cvar_Register (&loadas8bit);
	Cvar_Register (&ambient_level);
	Cvar_Register (&ambient_fade);
	Cvar_Register (&snd_noextraupdate);
	Cvar_Register (&snd_show);
	Cvar_Register (&snd_mixahead);
